...
<body>
                                                ...
                                                <div class="open-information-container">
                                                        ...
                                                        <?php
                                                                ...
                                                                if($day == 'Monday' || $day == 'Tuesday' || $day == 'Wednesday' || $day == 'Thursday' || $day == 'Friday')
                                                                {
                                                                    if($hour>=7 && $hour<16)
                                                                    {
                                                                    echo "<p class='open-information-db24 opening-hours-leszno'> DZISIAJ OTWARTE 07:00 - 16:00 <span class='arrow-down'>‹</span> </p>";
                                                                    }
                                                                    else
                                                                    {
                                                ...
                                                <div class="open-information-container">
                                                        <?php
                                                            ...
                                                            if($hour>=8 && $hour<=16)
                                                            {
                                                                if($day == 'Monday' || $day == 'Tuesday' || $day == 'Wednesday' || $day == 'Thursday' || $day == 'Friday')
                                                                {
                                                                    echo "<p class='open-information-db24 opening-hours-krzemieniewo'> DZISIAJ OTWARTE 08:00 - 16:00 <span class='arrow-down'>‹</span> </p>";
                                                                }
                                                                else if($day == 'Saturday' || $day == 'Sunday')
                                                                {
                                                                    echo "<p class='close-information-db24 opening-hours-krzemieniewo'>DZISIAJ ZAMKNIĘTE <span class='arrow-down'>‹</span></p>";
                                                                }
                                                            }
                                                            else
                                                            {
    ...
    <section class="main-block gray">
        <div class="container-fluid">
            ...
            $url = "https://budio.pl/hurtownia/1/promocje";

// echo file_get_contents($url, false, $context);

            $strJsonFileContents = file_get_contents($url, false, $context);
                    // Convert to array 
